...
Example FASTQ and template sequence files are included. For example, the following command may be run within an interactive Python session or from a Python script, and should complete within a few minutes:
